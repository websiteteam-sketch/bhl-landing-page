...
export default function ThankYou() {
  useEffect(() => {
    document.title = "Thank You | Hotels & Resorts Recovery Pod | BH Labs";
        ...
        <section className="py-16 md:py-24 bg-background">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                You're one step closer to turning underused hotel space into a premium wellness revenue stream.
              </motion.p>
            ...
            >
              <motion.div variants={FADE_UP} className="text-center mb-8">
                ...
                <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto">
                  In 30 minutes, we'll review your property layout, estimate revenue potential, and outline a clear path to launch. No commitment required.
                </p>
              </motion.div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-2xl md:text-3xl font-serif text-foreground mb-3">
                Why Hotels Add Recovery Pods
              </h2>
              <p className="text-muted-foreground text-base max-w-xl mx-auto">
                Properties that install a BH Labs Recovery Pod unlock measurable advantages.
              </p>
            </motion.div>
            ...
            >
              {[
                {
                  icon: DollarSign,
                  title: "New Revenue from Unused Space",
                  desc: "Convert underperforming square footage into a self-sustaining revenue center generating $25K+/month.",
                },
                {
                  icon: Sparkles,
                  title: "Premium Guest Experience",
                  desc: "Offer a recovery and wellness amenity that most competing properties simply don't have yet.",
                },
                {
                  icon: Zap,
                  title: "Fast Payback Potential",
                  desc: "Typical installations see payback in under 2 months based on utilization and pricing assumptions.",
                },
                {
                  icon: Settings,
                  title: "Turnkey Implementation",
                  desc: "BH Labs handles design, equipment, installation, and staff training — zero additional headcount required.",
                },
              ].map((card, i) => (
                <motion.div
                  key={i}
            ...
            >
              ...
              <motion.div variants={STAGGER} className="space-y-4">
                {[
                  {
                    icon: LayoutGrid,
                    title: "Review Your Layout",
                    desc: "We'll assess your available space and discuss optimal pod placement for maximum guest visibility and flow.",
                  },
                  {
                    icon: TrendingUp,
                    title: "Estimate Revenue Potential",
                    desc: "Using your property data, we'll model projected monthly revenue and payback timelines.",
                  },
                  {
                    icon: Settings,
                    title: "Discuss Configuration",
                    desc: "We'll recommend the right combination of modalities based on your guest profile and property type.",
                  },
                  {
                    icon: Clock,
                    title: "Outline Your Timeline",
                    desc: "From design approval to ribbon-cutting — we'll map out the implementation roadmap for your property.",
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
