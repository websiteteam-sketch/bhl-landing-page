  ...
  return (
    <section className="py-12 md:py-24 bg-background" id="faq">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-serif text-foreground mb-4">Questions athletics departments ask before moving forward</h2>
          <p className="text-muted-foreground text-lg">Practical answers to help you evaluate fit, feasibility, and projected savings for your program.</p>
        </motion.div>
