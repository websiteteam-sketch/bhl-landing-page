          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20">
            ...
            >
              ...
              <motion.div variants={FADE_UP} className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-secondary/50 text-secondary-foreground text-sm font-medium mb-6">
                ...
                <span>For Fitness and Sports Clubs</span>
              </motion.div>
        ...
        <section className="py-8 bg-secondary/30 border-b border-border">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-base md:text-lg text-foreground max-w-4xl mx-auto text-center leading-relaxed">
              <strong>BH Labs installs turnkey Recovery Pods</strong> in gyms, fitness studios, and sports clubs. A complete pod costs approximately <strong>$45,000</strong>, enables a <strong>premium membership tier</strong>, boosts member retention by up to <strong>30%</strong>, and pays for itself through higher-value memberships. No additional staff required.
            </p>
          </div>
        </section>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-xl p-6 border border-red-200 shadow-sm">
                  ...
                  <p className="text-sm text-muted-foreground">Boutique fitness and sports clubs are adding recovery — your members are noticing</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                >
                  From elite fitness brands to boutique sports clubs, BH Labs powers recovery for top facilities across South Florida.
                </motion.p>
